...
urlpatterns = [
    ...
    path('carrinho/adicionar/<int:cabaz_id>/', views.adicionar_ao_carrinho, name='adicionar_ao_carrinho'),
    path('carrinho/finalizar/', views.finalizar_carrinho, name='finalizar_carrinho'),
    # NOVA URL AQUI:
    path('carrinho/remover/<int:cabaz_id>/', views.remover_do_carrinho, name='remover_do_carrinho'),
]